...
export function OrderProductsCard({ items, orderStatus }: OrderProductsCardProps) {
    return (
        <Card>
                    ...
                    {items.length === 0 ? (
                        ...
                        <div className="divide-y">
                            {items.map((it) => {
                                ...
                                const lineStatus =
                                    orderStatus === "TERMINE" ? "Livré" : orderStatus === "PROD" ? "En cours" : "En attente";
                                ...
                                return (
                                    <div key={it.id} className="grid grid-cols-12 items-center px-4 py-3">
                                        ...
                                        <div className="col-span-2 flex justify-center">
                                            <Badge variant={orderStatus === "TERMINE" ? "outline" : "secondary"}>{lineStatus}</Badge>
                                        </div>
